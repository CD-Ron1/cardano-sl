...
importWalletJSON :: MonadWalletBackup ctx m => Maybe Int32 -> CFilePath -> m CWallet
...
exportWalletJSON :: MonadWalletBackup ctx m => Maybe Int32 -> CId Wal -> CFilePath -> m NoContent
